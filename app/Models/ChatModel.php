...
class ChatModel extends Model{
     ...
     protected $allowedFields = ['chat_id','owner_id','tenant_id','chat_description','date','date_time','is_send_me','status','time','admin_id','admin_name'];
 ...
 public function getOwnerNameTenatName($tenant_id,$owner_id){
   ...
   $this->select('tet.tenant_id,tet.name as tname');
   $this->select('chat.*');
   $this->select('adm.name');
   //$this->select('admin.name');
   $this->where('chat.tenant_id',$tenant_id);
   $this->where('chat.owner_id',$owner_id);
    $this->orderBy('chat.date','DESC');
   //$this->select('chat.chat_description,is_send_me,date,date_time');
