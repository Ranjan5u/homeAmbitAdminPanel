...
class AdminModel extends Model{
     ...
     protected $allowedFields = ['id','name','lname','email','mobile','password','admin_created','user_status','admin_type','temp_password','os','phone_model','lat','long','location','address','pan_no','user_refer','refer_by','instatallation_date','point','file_image','created_date','admin_name'];
