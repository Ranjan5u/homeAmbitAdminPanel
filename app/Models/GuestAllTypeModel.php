...
class GuestAllTypeModel extends Model{
    
     protected $table = 'all_type_guest';
     protected $primaryKey = 'id';
     protected $allowedFields = ['id','name','mobile','email','password','file_image','address','type','created_date','status','app_installation_date','app_installation_latitude','app_installation_lognitute','device_name','device_imei','installation_address','state','city','pincode'];
 ...
 public function getDataGuest($searchArray=array(), $offset='', $limit='',$coutOnly=''){
     ...
     if($coutOnly)
      ...
      if(isset($searchArray['txtsearch']) && $searchArray['txtsearch'])
        ...
        public function getGusetData($id=0){
