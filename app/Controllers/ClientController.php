...
class ClientController extends BaseController {
    ...
    public function viewClient(){
        ...
        $this->template->render('admintemplate','contents','admin/Client/viewClient',$data);
     ...
     public function addClient(){
        ...
        $this->template->render('admintemplate','contents','admin/Client/addclient',$data);
     ...
     public function saveDataClient(){
        ...
        $addguest->insert($data);
         ...
         $this->session->setFlashdata('message','Client Added');
       return redirect()->to(site_url('addclient'));

    }
  public function previewClient($id=0){
        ...
        $this->template->render('admintemplate','contents','admin/Client/previewClient',$data);
  ...
  public function edit_Client($id=0){
        ...
        // print_r($data['editGuest']);exit();
          ...
          $this->template->render('admintemplate','contents','admin/Client/edit_Client',$data);

    }
  public function updateDataClient($id=0){
      ...
      // print_r($image);exit();
       ...
       $data=[
        ...
        if($check){
            ...
            $this->session->setFlashdata('message','Client Updated');
            return redirect()->to(site_url('ClientController/edit_client/'.$id));
        }
    }
    ...
    $delete_GuestAlltype=new ClientModel();

    
    $delete_GuestAlltype->where('id',$id)->delete();

    return redirect()->to(site_url('viewClient'));
