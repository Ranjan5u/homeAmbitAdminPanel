                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="col-8 mt-2">
                               ...
                               <form class="custom-validation"  id='add_member_form' method='post' action="<?php echo site_url('GuestController/guestchangepassword'); ?>"  enctype='multipart/form-data'>
                             ...
                             <input type="password" class="form-control form-control-lg" id="new_password" name="password" placeholder="New password" required>
