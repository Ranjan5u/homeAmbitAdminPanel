            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        ...
                        <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('addguest');?>">
                                <i class="ion ion-md-add-circle-outline"></i> Add Guest
                            </a>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="<?php echo site_url('guest');?>"><button type="button" class="btn btn-primary waves-effect waves-light mr-1"
                        ...
                        <div class="card-body">
                         ...
                         <div class="table-responsive">
                              <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                               ...
                               <td ><?php echo $value->status == 'Active' ? "<p class='badge rounded-pill bg-success font-size-12' style='font-size: 15px !important;padding-right: 0.6em;padding-left: 0.6em; color: white;'>Active</p>" : "<p class='badge rounded-pill bg-danger font-size-12' style='font-size: 15px !important;padding-right: 0.6em;padding-left: 0.6em; color: white;'>In Active</p>"; ?></td>
