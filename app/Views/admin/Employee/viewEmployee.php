            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        ...
                        <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('addemployee');?>">
                                <i class="ion ion-md-add-circle-outline"></i> Add Employee
                            </a>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="<?php echo site_url('viewemployee');?>"><button type="button" class="btn btn-primary waves-effect waves-light mr-1"
                                    ...
                                    <tbody> 
                                        ...
                                        {?>
                                            ...
                                            <td  class="text-center" >
                                                     <a href="<?php echo site_url('EmployeeController/previewEmployee/'.$value->id);?>" class="btn btn-success btn-sm" title="preview" ><i class="fas fa-eye"></i></a>
                                                     &nbsp;&nbsp;&nbsp;
                                                  <a href="<?php echo site_url('EmployeeController/edit_employee/'.$value->id);?>" class="btn btn-primary btn-sm"  title="Edit"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
                                                 
                                                  <a href="<?php echo site_url('EmployeeController/delete_employee/'.$value->id);?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" title="delete"><i class="fa fa-trash"></i></a>
