...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                   <h2 class="mt-6 font-weight-semibold">Owner Details</h2> 
                  <table class="table table-striped table-bordered m-top20">
                     <tbody>
                         <tr>
                           ...
                           <th class="text-center">Owner Mobile</th>
                        </tr>

                        <tr>
                             <td class="text-center"><img src="<?php echo base_url('uploads/essential/'.$value['profile_image'])?> " style="height:109px;" ></td>
                ...
                <div class="row">
                  <div class="col-md-12">
                   <h2 class="mt-6 font-weight-semibold">Owner Property Details</h2> 
                  <table class="table table-striped table-bordered ">
                     <tbody> 
                      <tr>
                           <th scope="row">Tenant Name</th>
                           <td class="text-left"><?php echo $value['tname'];?></td>
                        </tr>

                         <tr>
                           <th scope="row">Property Name</th>
                           <td class="text-left"><?php echo $value['own_property_name'];?></td>
                        </tr>
                  ...
                  <table class="table table-striped table-bordered ">
                   ...
                   <a href="<?php echo site_url('viewOwner') ?>" class="btn btn-primary w-100" >Back</a>
               </div>
            </div>
   </div>
