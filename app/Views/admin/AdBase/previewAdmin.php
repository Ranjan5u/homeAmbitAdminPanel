<?php foreach ($previewad as $value) {?>
...
<div class="page-content adj">
    <div class="container-fluid">
            <div class="row">
               <div class="col-md-12">
                   <h2 class="mt-6 font-weight-semibold">Admin Details</h2> 
                  ...
                  <a href="<?php echo site_url('viewAdmin') ?>" class="btn btn-primary w-100" style="width:100%;">Back</a>
               </div>
            </div>
   </div>
</div>
