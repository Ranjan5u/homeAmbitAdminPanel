            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <form class="custom-validation" onsubmit="return validationForm()" method='post' action="<?php echo site_url('saveadmin');?>"
                                ...
                                <div class="row  form-group">
                                    ...
                                    <label style="font-size:12px;">Email</label>
                                       ...
                                       <div class="col-lg-4">
                                                ...
                                                <input type="text" style="font-size:12px;" name="address" placeholder="Enter Address" class="form-control form-control-lg">
