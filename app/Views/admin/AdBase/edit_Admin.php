            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                       ...
                       <form class="custom-validation" onsubmit="return validationForm()" method='post' action="<?php echo site_url('updatedataAdmin');?>"
                                         ...
                                         <div class="col-ting">
                                            <div class="control-group file-upload" id="file-upload1">
                                               <div class="image-box text-center">
                                                  <!-- <p>Upload Image</p> -->
                                                  <img src="<?php echo isset($editadmin['file_image']) ?  base_url('uploads/essential/'.$editadmin['file_image']):'';?>"  width="100" height="100" id="display_image_here">
                                               </div>
                                ...
                                <div class="row  form-group">
                                    ...
                                    <label style="font-size:12px;">Name</label>
                                          <input type="text" name="name" placeholder="Enter Name" style="font-size:12px;" class="form-control form-control-lg"  value="<?php echo $editadmin['name']?>">   
                                    ...
                                    <div class="col-lg-4 ">
                                        ...
                                        <label style="font-size:12px;">Mobile</label>
                                         <input type="number" name="mobile"  placeholder="Enter Mobile" style="font-size:12px;" class="form-control form-control-lg" value="<?php echo $editadmin['mobile']?>"> 
                                    ...
                                    <label style="font-size:12px;">Email</label>
                                          <input type="text" name="email"  placeholder="Enter Email" style="font-size:12px;" class="form-control form-control-lg" value="<?php echo $editadmin['email']?>">     
                                       ...
                                       <div class="col-lg-4">
                                                ...
                                                <input type="text" style="font-size:12px;" name="address" placeholder="Enter Address" class="form-control form-control-lg" value="<?php echo $editadmin['address']?>">
                                ...
                                <!--   <div class="row form-group">
                                        <div class="col-lg-4">
                                                ...
                                                <input type="password" id="visitorpassword1" style="font-size:12px;" name="password" placeholder="Enter password" class="form-control form-control-lg" value="<?php echo $editadmin['password']?>">
                                                 <span id="displayComments1" style="color:red"> </span>

                                        </div>
                                        <div class="col-lg-4">
                                                <label style="font-size:12px;">Re-Confirm Password</label>
                                                <input type="password" id="visitorpassword2" name="password" style="font-size:12px;"  class="form-control form-control-lg" placeholder="Confirm password" value="<?php echo $editadmin['password']?>">
                                ...
                                <div class="row  form-group">
                                    <div class="col-lg-4">  
                                           <input type="hidden" value="subadmin" name="admin_type">
                                           
                                            <input type="hidden" name="id" value="<?php echo isset($editadmin['id'])?$editadmin['id']:'';?>">                      
