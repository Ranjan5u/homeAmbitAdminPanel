        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="col-12">
                            <h4 class="mb-4">Add Advertisement</h4>
                            <form class="custom-validation" method='post' action="<?php echo site_url('HomeAmbitAdvertisementController/AddedDataAdvertisementStore');?>"
                                ...
                                <div class="row  form-group">
                                    ...
                                    <label style="font-size:16px;">Advertisement Name</label>
                                       <input type="text" name="adt_name" required placeholder="Advertisement Name" style="font-size:12px;" class="form-control form-control-lg" >
                                    ...
                                    <div class="col-lg-4 ">
                                        ...
                                        <input type="file" name="adt_file" required placeholder="" style="font-size:12px;" class="form-control form-control-lg" onchange="readURL(this);" accept=".png, .jpg, .jpeg" >  
                                        <br>
                                        <img id="blah" src="//www.tutsmake.com/wp-content/uploads/2019/01/no-image-tut.png"  width="200" height="150"/> 
                                    </div>
                                </div> 
