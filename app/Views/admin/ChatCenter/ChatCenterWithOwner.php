                    ...
                    <div class="card-body">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-4 ">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control" name="txtsearch" placeholder="Search By Owner Name" type="text" value="<?php echo $txtsearch;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="<?php echo site_url('chatOwner');?>"><button type="button" class="btn btn-primary waves-effect waves-light mr-1"
                                ...
                                <table id="example" class="table table-striped table-bordered table-nowrap" style="width:100% " id="livesearch">
                                    ...
                                    <tbody> 
                                        ...
                                        {?>
                                            ...
                                            <a href="<?php echo site_url('adminChat?owner_id='.$value->owner_id.'&admin='.$sess);?>" class="btn btn-success btn-sm" title="Chat With This Owner"><i class="fa fa-comments"></i></a>      
                                            </td>                                         
                                        </tr>
                                        <?php }?>    
                                    </tbody>
