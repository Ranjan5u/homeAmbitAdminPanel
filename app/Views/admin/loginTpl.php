    <div class="account-pages ">
        ...
        <div class="navbar-header bg-seconday border-bottom" style="background-color:#FF5151;">
            <div class="d-flex float-left ml-4">
            <a href="<?php echo site_url('dashboard'); ?>" > <img src="<?php echo base_url('public/images/home_ambit.png'); ?>" height="65"  style="background-color: #fff;" alt="<?php echo SITE_NAME;?>"></a>
            </div>
                <div class="d-flex">
                                    ...
                                    <div class=" form-group" >
                                        ...
                                        <div class="col-sm-6">
                                            <div class="custom-control  custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="customControlInline" name="adminremember" <?php echo isset($adminremember) ? 'checked' : ''; ?>>
