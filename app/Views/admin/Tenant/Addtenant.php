...
?>
                            ...
                            <form class="custom-validation" onsubmit="return validationForm()" method='post' action="<?php echo site_url('Tenant/saveDataTenant');?>"
                                ...
                                <div class="row  form-group">
                                 ...
                                 <option  value="" style="font-size:14px;">-- Select Owner --</option>
                                    ...
                                    <?php foreach($ownerDropdown as $uti): ?>
                                          ...
                                          <option value="<?php echo $uti['owner_id']; ?>" <?php echo isset($uti) && $uti['owner_id'] ? $uti['name']:''?>style="font-size:12px;">
                                    ...
                                    <br>
                                     <?php if($validation->getError('owner_id')) {?>
                                        <div class='text-danger'>
                                          <?= $error = $validation->getError('owner_id'); ?>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="row  form-group">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <input type="date" style="font-size:12px;" name="ten_rent_date" placeholder="Enter Rent Date" class="form-control form-control-lg">

                                        </div>
                                        <div class="col-lg-4">
                                                <label style="font-size:12px;">Rent Duration</label>
                                                  <input type="date" style="font-size:12px;" name="ten_rent_duration" placeholder="Enter Rent Duration" class="form-control form-control-lg">
                                        </div>

                                    <div class="col-lg-4 ">
                                    <label style="font-size:12px;">Renewed Date</label>
                                          <input type="date" name="ten_renewed_date" placeholder="Enter Renewed Date" style="font-size:12px;" class="form-control form-control-lg" >   
                                ...
                                <div class="row  form-group">
                                    ...
                                    <div class="col-lg-4 ">
                                        ...
                                        <label style="font-size:12px;">Rent Start Date</label>
                                         <input type="date" name="ten_start_date"  placeholder="Enter Rent Start Date" style="font-size:12px;" class="form-control form-control-lg" > 
                                        
                                    </div>

                                     <div class="col-lg-4 ">
                                    <label style="font-size:12px;">Rent End Date</label>
                                          <input type="date" name="ten_end_date"  placeholder="Enter Rent End Date" style="font-size:12px;" class="form-control form-control-lg">     

                                    </div>
                                     <div class="col-lg-4 ">
                                    <label style="font-size:12px;">Property Name</label>
                                          <input type="text" name="ten_property_name" placeholder="Enter Property Name" style="font-size:12px;" class="form-control form-control-lg" id="username">   
                                          <span id = "usernametenat" style="color:red;"> </span>
                                ...
                                <div class="row  form-group">
                                    ...
                                    <div class="col-lg-4 ">
                                        ...
                                        <label style="font-size:12px;">Project Name</label>
                                         <input type="text" name="ten_project_name"  placeholder="Enter Project Name" style="font-size:12px;" class="form-control form-control-lg" > 
                                         ...
                                         <div class="col-ting">
                                            <div class="control-group file-upload" id="file-upload1">
                                               ...
                                               <div class="controls" style="display: none;">
                                                  <input type="file" accept="image/*"  name="pro_image" value="<?php echo (isset($edit) && !empty($edit)) ? $edit['pro_image'] : ''; ?>" >
                                               </div>
                                            </div>
                                         </div>
