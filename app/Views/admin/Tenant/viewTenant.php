            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        ...
                        <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('addtenant');?>">
                                <i class="ion ion-md-add-circle-outline"></i> Add Tenant
                            </a>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="<?php echo site_url('viewTenant');?>"><button type="button" class="btn btn-primary waves-effect waves-light mr-1"
                               ...
                               <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    <thead style="background-color:#95004D;">
                                        <tr>
                                           ...
                                           <th data-sortable="true" class="text-center">Pincode</th>
                                        ...
                                        {?>
                                            ...
                                            <td  class="text-center"> <?php echo $value->email;?></td>
                                             <td  class="text-center"> <?php echo $value->mobile;?></td>
                                              <td  class="text-center"> <?php echo $value->pincode;?></td>
                                             
                                            


                                            <td  class="text-center" >
                                                     <a href="<?php echo site_url('TenantController/previewTenant/'.$value->tenant_id);?>" class="btn btn-success btn-sm" title="preview" ><i class="fas fa-eye"></i></a>
                                                     &nbsp;&nbsp;&nbsp;
                                                  <a href="<?php echo site_url('TenantController/edit_Tenant/'.$value->tenant_id);?>" class="btn btn-primary btn-sm"  title="Edit"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
                                                 
                                                  <a href="<?php echo site_url('TenantController/delete_Tenant/'.$value->tenant_id);?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" title="delete"><i class="fa fa-trash"></i></a>
