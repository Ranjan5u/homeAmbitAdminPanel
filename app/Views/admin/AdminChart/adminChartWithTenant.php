    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-20" style="margin-left: 109px;">Chat Tenant </h4>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                <div class="dropdown">
                    <a href="<?php echo site_url('chatTenant');?>" class="btn btn-secondary waves-effect waves-light" style="background-color:#FF5151;">
     ...
     <div class="simplebar-offset" style="right: -20px; bottom: 0px;">
        ...
        <div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div>
             ...
             <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                    ...
                    <div class="row">
                             <div class="col-lg-12">
                           <form action="<?php echo site_url('adminChartSynchronouswithTenant');?>" method="post"  enctype='multipart/form-data' class="msger-inputarea">
