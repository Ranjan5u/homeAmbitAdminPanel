    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-20" style="margin-left: 109px;">Chat Guest </h4>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                <div class="dropdown">
                    <a href="<?php echo site_url('chatGuest');?>" class="btn btn-secondary waves-effect waves-light" style="background-color:#FF5151;">
 ...
 <div class="simplebar-mask" id="messages">
     <div class="simplebar-offset" style="right: -20px; bottom: 0px;">
        ...
        <div class="simplebar-content" style="padding: 0px 10px;" id="chatlist">
                ...
                <p> <?php echo $kdata['admin_chat_desc']; ?></p></div></div>
                </li>
        ...
        <span class="time"><?php //echo $kdata->created_date;   ?></span>
            ...
            <span class="user-name"><?php echo $kdata['date']; ?></span>
                                     <p>
                                                 <?php echo $kdata['admin_chat_desc']; ?>
                                                                        </p>
                                                                            </div>
                                                                                    </div>
                                                                                </li>
        ...
        <div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div>
             ...
             <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                    ...
                    <div class="row">
                             <div class="col-lg-12">
                           <form action="<?php echo site_url('adminChartSynchronouswithGuest');?>" method="post"  enctype='multipart/form-data' class="msger-inputarea">
                                <textarea type="text" name="admin_chat_desc" rows="1" class="form-control" placeholder="Enter your message..."></textarea> 
                                
                                 <input type="hidden" name="gus_id" value="<?php echo isset($gus_iid)?$gus_iid:'';?>">
